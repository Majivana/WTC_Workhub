...
public final class WeeklyProgressResponse {
    ...
    public WeeklyProgressResponse(BigDecimal targetHours, BigDecimal loggedHours, BigDecimal verifiedHours,
                                  BigDecimal pendingHours, BigDecimal remainingHours, BigDecimal percentage,
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WeeklyProgressResponse other)) return false;
        return Objects.equals(targetHours, other.targetHours) && Objects.equals(loggedHours, other.loggedHours)
                && Objects.equals(verifiedHours, other.verifiedHours) && Objects.equals(pendingHours, other.pendingHours)
                && Objects.equals(remainingHours, other.remainingHours) && Objects.equals(percentage, other.percentage)
                && status == other.status;
    }

    @Override
    public int hashCode() { return Objects.hash(targetHours, loggedHours, verifiedHours, pendingHours, remainingHours, percentage, status); }

    @Override
    public String toString() {
        return "WeeklyProgressResponse[targetHours=" + targetHours + ", loggedHours=" + loggedHours
                + ", verifiedHours=" + verifiedHours + ", pendingHours=" + pendingHours
                + ", remainingHours=" + remainingHours + ", percentage=" + percentage + ", status=" + status + "]";
    }
}
